...
function Resultado() {
    ...
    // Continuar la causa en Redactar/Auditar con los datos del análisis precargados
    const irConAnalisis = (ruta) => navigate(ruta, {
        state: {
            desdeAnalisis: {
        ...
        <div className="resultado">
            ...
            <footer className="resultado__footer">
                ...
                <div className="resultado__actions">
                    ...
                    {capacidad === 'analizar' && pasoActual === 2 && !!data && (
                        <>
                            <button className="btn btn--secondary" onClick={() => irConAnalisis('/redactar')}>
                            ...
                            <button className="btn btn--secondary" onClick={() => irConAnalisis('/auditar')}>
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="16" height="16">
